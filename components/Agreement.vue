<template>
  <div class="agreement">
    <b-button v-b-modal.agreement>Launch demo modal</b-button>

    <b-modal id="agreement" title="Agreement">
           <p class="my-4"><ul>
          <li>商務團成團最低人數20人， 超值團成團最低 人數25人。</li>
          <li>於出發前第41日以前取消訂單，需收取訂單全額5%手續費；<br>
於出發前31至40天取消訂單，需收取訂單全額10%手續費；<br>
於出發前21至30天取消訂單，需收取訂單全額20%手續費；<br>
於出發前2至20天取消訂單，需收取訂 單全額30%手續費；<br>
於出發前1天取消訂單，需收取訂單全額50%手續費；<br>
於出發當天取消訂單、集合逾時、因個人因素私自脫隊、及未通知不參加者恕不退費。</li>
          <li>本行程如預颱風、地震、豪雨等不可抗拒之因素，本公司保有延期出發或退費之權利。</li>
          <li>依據您在本網上訂購並完成交易的內容及費用開立『旅行業 代收轉付』（非發票但效力等同）；如需開立抬頭統編，則請詳細填寫公司名稱、統一編號等資料後，我們將於出發當日由隨團秘書轉交給您。</li>
          <li>透過線上報名的貴賓，本公司保留是否接受報名的權利</li>
      </ul></p>
      <div class="scroller">
        <p align="center">國內旅遊定型化契約</p>
        <p align="center">中華民國105年12月12日觀業字第1050922838號函修正</p>
        <p></p>
        <p>立契約書人</p>
